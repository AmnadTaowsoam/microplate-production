...
// ─── Load common settings (monorepo root .env.common) ────────────────────────
// Starting from .../data-service/src/configs, go up four levels to the project root
dotenv.config({ path: (0, path_1.join)(__dirname, '../../../../.env.common') });
// ─── Load data-service overrides (services/data-service/.env.data) ─────────────
dotenv.config({ path: (0, path_1.join)(__dirname, '../../../.env.data') });
...
exports.PORT = Number(process.env.PORT) || 3105;
// JWT / token settings
...
// If you later need refresh tokens:
